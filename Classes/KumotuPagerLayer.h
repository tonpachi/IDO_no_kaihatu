...
#ifndef __kyojin__KumotuPagerLayer__
#define __kyojin__KumotuPagerLayer__
...
#define NOTIFY_SP_PAGER4 "notification_KumotuPagerLayer"

USING_NS_CC;



class KumotuPagerLayer :public CCLayer{
...
#endif /* defined(__kyojin__KumotuPagerLayer__) */
